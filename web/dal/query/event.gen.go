...
func newEvent(db *gorm.DB, opts ...gen.DOOption) event {
	...
	_event.State = field.NewInt32(tableName, "state")
	_event.Time = field.NewTime(tableName, "time")
	_event.Type = field.NewInt32(tableName, "type")
	_event.Position = field.NewString(tableName, "position")
...
type event struct {
	...
	State    field.Int32
	Time     field.Time
	Type     field.Int32 // 1-交通事故，2-犯罪事件， 3-火灾事故
